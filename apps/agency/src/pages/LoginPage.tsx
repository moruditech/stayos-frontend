...
export default function LoginPage(): React.ReactElement {
  ...
  const form = useForm<LoginInput>({
    ...
    defaultValues: { email: '', password: '', userType: 'agency', rememberMe: false },
  });
  ...
  return (
    <div data-login-page data-portal="agency">
      <div data-login-left>
        <div data-login-portal-label>AGENCY PORTAL</div>
        <h1>Manage your<br /><span data-login-headline-accent>property portfolio.</span></h1>
        <p data-login-subtitle>
          Manage mandates, oversee bookings across your properties, and
          coordinate your agency staff.
        </p>
      </div>
