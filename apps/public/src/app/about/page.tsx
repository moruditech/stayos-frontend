...
import { Play, Users, GraduationCap, Building2, Landmark, Globe, User, Settings, Check, ChevronDown, Home as HomeIcon, type LucideIcon } from 'lucide-react';
  ...
  return (
    <>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', minHeight: '480px', display: 'flex', alignItems: 'center' }}>
        {/* Image: /images/about-hero.jpg — Cape Town aerial */}
        <img
