...
interface LedgerExpense {
  ...
  status: string;
  createdAt: string;
  submittedBy?: { firstName?: string | undefined; lastName?: string };
}
  ...
  return (
    <div data-page="pettycash-ledger">
      <div data-page-header>
        <div>
          <Link href="/accounting/pettycash" data-breadcrumb><Icons.ChevronLeft data-breadcrumb-icon aria-hidden="true" /> Petty cash floats</Link>
