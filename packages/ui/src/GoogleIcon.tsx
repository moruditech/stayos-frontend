...
/**
 * Official-style multi-color Google "G" mark, used on OAuth buttons.
 * Shared here so every app (customer, property, ...) renders the same
 * real logo instead of each app faking its own placeholder icon.
 */
