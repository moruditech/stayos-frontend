...
export const ROLE_PERMISSIONS: Record<string, string[]> = {
  ...
  agency_manager: [
    ...
    'report:read', 'housekeeping:*', 'maintenance:*', 'asset:*', 'folio:*',
    'staff:manage', 'channel:manage',
  ],
  agency_supervisor: [
  ...
  property_owner: [
    'property:*',
    'booking:*', 'room:*', 'folio:*',
    'housekeeping:*', 'maintenance:*', 'asset:*',
    ...
    'staff:roster:manage',
    'access:manage', 'access:policy:manage',
    'procurement:manage',
    'expense:approve', 'pettycash:manage', 'accounting:manage', 'channel:manage',
    'promotion:manage', 'rate:*', 'availability:*',
    'billing:manage',
    'messaging:manage', 'messaging:assign',
  ],
  property_admin: [
    'booking:*', 'room:*', 'staff:manage', 'staff:permissions:manage',
    'guest:manage', 'report:read', 'housekeeping:*', 'maintenance:*', 'asset:*',
    'folio:*', 'payment:read', 'payroll_export:read',
    'staff:roster:manage',
    'procurement:manage',
    'expense:approve', 'accounting:manage', 'access:manage', 'access:policy:manage',
    'complaint:manage', 'messaging:manage', 'channel:manage',
  ],
  property_manager: [
    'booking:*', 'room:*', 'guest:manage', 'report:read',
    'housekeeping:*', 'maintenance:*', 'asset:*', 'folio:*', 'payment:read',
    'payroll_export:read',
    'staff:roster:manage',
    'procurement:manage', 'expense:approve', 'accounting:manage',
  ...
  receptionist: [
    ...
    'guest:read', 'folio:read', 'access:manage',
    'messaging:read',
  ],
  revenue_manager: ['rate:*', 'availability:*', 'report:revenue:read', 'promotion:manage'],
  hr_manager: [
    'staff:read', 'staff:create',
    'hr:profile:manage', 'hr:document:manage',
    'hr:disciplinary:manage', 'hr:probation:manage', 'hr:performance:manage',
    'payroll_export:read',
    'staff:roster:manage',
    'timeclock:read',
  ],
